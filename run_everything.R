...
output <- uni_sims_par(tst = c(0), 
                       ...
                       init.prev = c(0.0025), # best-mid-worst
                       ppn_sympt = c(0.35), # best-worst
                       care.seeking = c(0.5), # worst-best
                       R0.on = c(2.3),  # best-mid-worst
                       R0.off = c(2.3), # best-mid-worst
                       test.scenario = c("1 Day"),# best-worst
