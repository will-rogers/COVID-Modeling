...
uni_sims_cost_par <- function(test_budget = 1,
                         test_proportion = 0,
                         ...
                         cost.PCR = 12.50,
                         ncores=NULL){
  vars <- expand.grid("test_budget" = test_budget,
  ...
  if (is.null(ncores)){
  output <- rbindlist(apply(vars,1,FUN=function(x) uni_sim_cost(test_budget = x[1], 
                                                           compliance = x[2], 
                                                           init.prev = x[3], 
                                                           ppn_sympt = x[4], 
                                                           care.seeking = x[5], 
    ...
    output <- rbindlist(parallel::parApply(cl,vars,1,
                                           FUN=function(x) uni_sim_cost(test_budget = x[1], 
                                                                   compliance = x[2], 
                                                                   init.prev = x[3], 
                                                                   ppn_sympt = x[4], 
                                                                   care.seeking = x[5], 
  ...
  output[,test_budget:=test_budget]
